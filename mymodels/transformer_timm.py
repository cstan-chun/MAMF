...
class SelfAttention(nn.Module):
    def __init__(self, in_dim_k, in_dim_q, out_dim, num_heads=8, proj_drop=0.1, qkv_bias=False, qk_scale=None,
                 attn_drop=0.):
        super().__init__()
...
class AttentionBlock(nn.Module):
    ...
    def __init__(self, in_dim_k, in_dim_q, out_dim, num_heads, mlp_ratio=2., qkv_bias=False, qk_scale=None, drop=0.,
        ...
        self.attn = SelfAttention(in_dim_k=in_dim_k, in_dim_q=in_dim_q,
